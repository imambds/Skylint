            ...
            {deleteModal && (
              ...
              >
                <div className="flex items-start justify-between">
                  ...
                  <button onClick={() => setDeleteModal(false)} className="ml-auto inline-flex items-center rounded-lg bg-transparent p-1.5 text-sm text-gray-400 hover:bg-low-navy hover:text-white hover:cursor-pointer" type="button">
                ...
                <div className="text-center">
                  ...
                  <div className="flex flex-col sm:flex-row justify-center items-center gap-4">
                    <button className="text-white bg-red-600 border border-transparent hover:bg-red-700 focus:ring-4 focus:ring-red-300 disabled:hover:bg-red-800 focus:!ring-2 group flex h-min w-fit items-center justify-center p-0.5 text-center font-medium focus:z-10 rounded-lg" type="button" onClick={() => {
                      handleDelete(i);
                      setDeleteModal(false);
                    }}>
                      <span className="flex items-center rounded-md text-sm px-4 py-2">Yes, I'm sure</span>
                    </button>
                    <button className="bg-transparent text-gray-400 border border-gray-600 hover:text-white focus:ring-2 focus:!ring-2 group flex h-min w-fit items-center justify-center p-0.5 text-center font-medium focus:z-10 rounded-lg" type="button" onClick={() => setDeleteModal(false)}>
                      <span className="flex items-center rounded-md text-sm px-4 py-2">No, cancel</span>
                    </button>
                  </div>
                </div>
              </Modal>
        ...
        <div>
          ...
          >
            ...
            <form onSubmit={requestUser}>
              ...
              <input type="text" className="bg-low-navy text-white text-sm rounded-md focus:outline-none block w-full p-2.5" placeholder="Your City" onChange={handleChange} autoFocus />
